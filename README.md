...
- несовпадение ссылок в тексте и массива `citations`;
...
Следующий этап — отдельно разрешённый live smoke test Qwen, затем generation evaluation:
groundedness, полнота цитат, качество отказа, latency и скорость генерации.
